...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_wasmer = dict(
        project_name = "wasmer",
        project_desc = "A standalone runtime for WebAssembly",
        project_url = "https://github.com/wasmerio/wasmer",
        version = "2.0.0",
        sha256 = "f0d86dcd98882a7459f10e58671acf233b7d00f50dffe32f5770ab3bf850a9a6",
        strip_prefix = "wasmer-{version}",
        urls = ["https://github.com/wasmerio/wasmer/archive/{version}.tar.gz"],
        release_date = "2021-06-16",
        use_category = ["dataplane_ext"],
        extensions = ["envoy.wasm.runtime.wasmer"],
        cpe = "N/A",
    ),
    com_github_wasm_c_api = dict(
        ...
        use_category = ["dataplane_ext"],
        extensions = ["envoy.wasm.runtime.wasmtime", "envoy.wasm.runtime.wasmer"],
        cpe = "N/A",
    ),
    ...
    proxy_wasm_cpp_host = dict(
        ...
        project_url = "https://github.com/StarCrossPortal/proxy-wasm-cpp-host.git",
        version = "7f17f45fddf49ea685f9193670dfe576af407c75",
        sha256 = "38ab43d3af34a90852cc9f0809f1f578efe4790027709d5af00c98c8395fe562",
        strip_prefix = "proxy-wasm-cpp-host-{version}",
        urls = ["https://github.com/StarCrossPortal/proxy-wasm-cpp-host/archive/{version}.tar.gz"],
        use_category = ["dataplane_ext"],
        extensions = [
            "envoy.access_loggers.wasm",
            "envoy.bootstrap.wasm",
